...
public class DivStatement implements ExecutableStatement<Integer> {
    private ExecutableStatement<Integer> operand1, operand2;

    public DivStatement(ExecutableStatement<Integer> operand1, ExecutableStatement<Integer> operand2) {
